...
import text_preprocessing_utils as preprocess_utils
import text_generation_utils as gen_utils
import torch
...
old_event_csv = '/home/otamy001/EvoLang/2013_year.csv'
new_event_csv = '/home/otamy001/EvoLang/2023_year.csv'
...
gen_utils.save_results_to_csv(old_results, "generated_responses_2013.csv")
new_results = gen_utils.process_in_batches(new_events, model, tokenizer)
gen_utils.save_results_to_csv(new_results, "generated_responses_2023.csv")
